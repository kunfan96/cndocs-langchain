...
本示例展示如何使用 AI21SemanticTextSplitter 根据语义含义将文本分割成片段。
...
本示例展示如何使用 AI21SemanticTextSplitter 根据语义含义将文本分割成片段，然后根据 `chunk_size` 对片段进行合并。
...
本示例展示如何使用 AI21SemanticTextSplitter 根据语义含义将文本分割为 Documents。每个文档的元数据中将包含其类型。
...
本示例展示如何使用 AI21SemanticTextSplitter 根据语义含义将文本分割为 Documents。每个文档的元数据中将包含其起始索引。
**注意**：起始索引仅表示片段的顺序，而非每个片段的实际起始位置。
...
本示例展示如何使用 AI21SemanticTextSplitter 根据语义含义将一组 Documents 分割成片段。
