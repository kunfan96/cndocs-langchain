---
title: "PubMed 集成"
description: "使用 LangChain Python 集成 PubMed 文档加载器。"
---

>[PubMed®](https://pubmed.ncbi.nlm.nih.gov/) 由 `美国国立生物技术信息中心（National Center for Biotechnology Information）、美国国家医学图书馆（National Library of Medicine）` 提供，收录了来自 `MEDLINE`、生命科学期刊及在线书籍的 3500 多万条生物医学文献引用。引用内容可能包含来自 `PubMed Central` 和出版商网站的全文内容链接。
