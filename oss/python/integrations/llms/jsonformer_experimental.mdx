---
title: "JSONFormer 集成"
description: "使用 LangChain Python 与 JSONFormer LLM 集成。"
---

[JSONFormer](https://github.com/1rgs/jsonformer) 是一个库，它封装了本地的 Hugging Face 管道模型，用于对 JSON Schema 的子集进行结构化解码。

它的工作原理是先填充结构令牌，然后从模型中采样内容令牌。
...
***这并不那么令人印象深刻，对吧？它完全没有遵循 JSON 格式！让我们尝试使用结构化解码器。***
