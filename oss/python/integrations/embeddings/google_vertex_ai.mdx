...
description: "使用 LangChain Python 与 Google Vertex AI 嵌入模型集成。"
---

<Danger>
    **已弃用**

    此集成已弃用，并将在未来版本中移除。请改用 [`GoogleGenerativeAIEmbeddings`](/oss/python/integrations/embeddings/google_generative_ai)。请参阅完整的[发布说明和迁移指南](https://github.com/langchain-ai/langchain-google/discussions/1422)。
</Danger>

这将帮助您开始使用 LangChain 的 Google Vertex AI 嵌入模型。有关 `Google Vertex AI Embeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-google-vertexai/embeddings/VertexAIEmbeddings)。
...
前往 [Google Cloud](https://cloud.google.com/free/) 注册创建账户。完成此操作后，设置 GOOGLE_APPLICATION_CREDENTIALS 环境变量：
...
有关 `Google Vertex AI Embeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-google-vertexai/embeddings/VertexAIEmbeddings)。

---

<div className="source-links">
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/embeddings/google_vertex_ai.mdx) 或[提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
