...
<Warning>
    本页提及 [Groq](https://console.groq.com/docs/overview)，一家 AI 硬件和软件公司。有关如何使用 Grok 模型（由 [xAI](https://docs.x.ai/docs/overview) 提供）的信息，请参阅 [xAI 提供者页面](/oss/python/integrations/providers/xai)。
</Warning>
...
要获取所有 Groq 模型的列表，请访问其[文档](https://console.groq.com/docs/models?utm_source=langchain)。
...
有关支持视觉的模型的最新列表，请查看 [Groq 文档](https://console.groq.com/docs/vision)。
</Note>
...
有关所有 `ChatGroq` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/python/langchain-groq/chat_models/ChatGroq)。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/chat/groq.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>