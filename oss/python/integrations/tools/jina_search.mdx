---
title: "Jina 搜索集成"
description: "使用 LangChain Python 与 Jina 搜索工具集成。"
---

本指南提供了开始使用 `JinaSearch` [工具](/oss/python/integrations/tools/) 的快速概述。有关所有 `JinaSearch` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/python/langchain-community/tools/jina_search/tool/JinaSearch)。
...
我们可以通过首先将其绑定到一个[工具调用模型](/oss/python/langchain/tools/)，然后调用它，从而在链中使用我们的工具：
...
有关所有 Jina 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/python/langchain-community/tools/jina_search/tool/JinaSearch)
