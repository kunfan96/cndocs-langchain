...
Perigon API 套件提供对全球新闻和事件的快速、结构化访问，帮助您构建实时、数据驱动的产品。无论您是跟踪新兴风险、展示相关文章，还是发现关键见解，Perigon 都为您提供以编程方式完成这些任务的工具。
...
您需要 Perigon API 密钥才能使用此集成。请在 [Perigon.io](https://perigon.io/) 注册以获取您的 API 密钥。
...
WikipediaRetriever 提供对维基百科内容的语义搜索功能，并附带丰富的元数据：
