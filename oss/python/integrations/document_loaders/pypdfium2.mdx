...
本指南提供了快速入门 `PyPDF` [文档加载器](/oss/python/integrations/document_loaders) 的概览。有关所有 `DocumentLoader` 功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/PyPDFium2Loader)。
...
有关所有 `PyPDFium2Loader` 功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/PyPDFium2Loader)
