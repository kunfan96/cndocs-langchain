...
- 前往 [Dataherald](https://www.dataherald.com) 并注册
- 创建一个应用并获取你的 `API KEY`
...
存在一个 DataheraldAPIWrapper 实用工具，它封装了此 API。要导入此工具：

```python
from langchain_community.utilities.dataherald import DataheraldAPIWrapper
```

有关此封装器的更详细演练，请参阅[此笔记本](/oss/python/integrations/tools/dataherald)。
