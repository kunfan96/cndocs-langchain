---
title: "Bing 搜索集成"
description: "使用 LangChain Python 与 Bing 搜索工具集成。"
---

> [Bing Search](https://learn.microsoft.com/en-us/bing/search-apis/bing-web-search/) 是一项 Azure 服务，可提供安全、无广告、基于位置的搜索结果，从数十亿个网络文档中提取相关信息。通过利用 Bing 能够通过单次 API 调用梳理数十亿网页、图像、视频和新闻的能力，帮助您的用户从万维网中找到他们想要的内容。
...
我们在此展示如何将其作为[代理](/oss/python/langchain/agents)的一部分使用。我们使用 OpenAI Functions Agent，因此需要设置并安装所需的依赖项。我们还将使用 [LangSmith Hub](https://smith.langchain.com/hub) 来提取提示，因此需要安装它。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/tools/bing_search.mdx) 或[提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
