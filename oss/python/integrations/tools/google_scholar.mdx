...
description: "使用 LangChain Python 与 Google Scholar 工具集成。"
---

本笔记本介绍如何使用 Google Scholar 工具。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/tools/google_scholar.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
