...
1. 您首先需要安装官方的 Notion 客户端和 [notion-to-md](https://www.npmjs.com/package/notion-to-md) 包作为对等依赖项：
...
3. 在您的页面或数据库上添加与新集成的连接。为此，请打开您的 Notion 页面，转到右上角的设置菜单，向下滚动到 `Add connections`，然后选择您的新集成。
...
const dbLoader = new NotionAPILoader({
  ...
  propertiesAsHeader: true, // 将页面属性的 front matter 标题添加到页面内容之前
});

// 数据库行的内容可能少于 1000 个字符，因此不会被分割成多个文档
