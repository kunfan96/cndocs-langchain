...
description: "使用 LangChain Python 与 LindormVectorStore 进行集成。"
---
...
[前往 Lindorm 注册文档](https://help.aliyun.com/document_detail/2773369.html?spm=a2c4g.11186623.help-menu-172543.d_2_5_0.2a383f96gr5N3M&scm=20140722.H_2773369._.OR_help-T_cn~zh-V_1) 注册 Lindorm 并生成 ak/sk。
...
有关所有 `LindormVectorStore` 功能和配置的详细文档，请访问 [API 参考](https://pypi.org/project/langchain-lindorm-integration/)。
