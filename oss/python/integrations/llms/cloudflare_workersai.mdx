...
description: "使用 LangChain Python 集成 Cloudflare Workers AI 大语言模型。"
---

[Cloudflare AI 文档](https://developers.cloudflare.com/workers-ai/models/)列出了所有可用的生成式文本模型。

使用时需要 Cloudflare 账户 ID 和 API 令牌。请参阅[此文档](https://developers.cloudflare.com/workers-ai/get-started/rest-api/)了解如何获取它们。
