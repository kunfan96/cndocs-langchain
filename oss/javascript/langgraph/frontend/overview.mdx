...
[LangChain 前端模式](/oss/javascript/langchain/frontend/overview)——Markdown 消息、工具调用、乐观更新等——适用于任何 LangGraph 图。`useStream` 钩子提供相同的核心 API，无论您使用 `createAgent`、`createDeepAgent` 还是自定义的 `StateGraph`。
