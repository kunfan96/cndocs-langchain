...
本指南提供 LangSmith [文档加载器](https://python.langchain.com/docs/concepts/document_loaders)的快速入门概览。关于 LangSmithLoader 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/core/document_loaders/langchain_core.document_loaders.langsmith.LangSmithLoader.html)。
...
要使用 LangSmith 文档加载器，需要安装 `langchain-core`，创建 [LangSmith](https://langsmith.com) 账户并获取 API 密钥。

### 凭证

在 [langsmith.com](https://langsmith.com) 注册并生成 API 密钥，然后设置 LANGSMITH_API_KEY 环境变量：
...
如果需要自动化的最佳追踪，可以开启 LangSmith 追踪：
...
在此示例中，我们将克隆并加载一个公开的 LangSmith 数据集。克隆会在您的个人 LangSmith 账户中创建该数据集的副本。您只能加载拥有个人副本的数据集。
...
关于 LangSmithLoader 所有功能和配置的详细文档，请参阅 API 参考：[python.langchain.com/api_reference/core/document_loaders/langchain_core.document_loaders.langsmith.LangSmithLoader.html](https://python.langchain.com/api_reference/core/document_loaders/langchain_core.document_loaders.langsmith.LangSmithLoader.html)

---

<div className="source-links">
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/langsmith.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
