---
title: "Drasi 集成"
description: 通过 Drasi 的持续查询平台将智能体连接到实时数据变更
---
...
当您的工作流正忙于其他事情时，这对于缓冲传入的变更通知非常有用；然后您可以在工作流中设置一个循环，在准备好时从缓冲区消费通知。
...
- [交互式聊天](https://github.com/drasi-project/langchain-drasi/tree/main/examples/chat)：一个使用 Drasi 进行实时记忆更新的聊天应用程序。
