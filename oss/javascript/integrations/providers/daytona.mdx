...
description: "将 Daytona 沙箱后端与 deepagents 结合使用，实现具有快速冷启动的隔离代码执行"
---

[Daytona](https://daytona.io) 提供支持多语言的快速启动沙箱环境。最适合 TypeScript 和 Python 开发。
...
| `SANDBOX_NOT_FOUND` | 未找到沙箱 ID 或已删除 |
