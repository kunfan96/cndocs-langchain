...
LangSmith 可以通过 OpenTelemetry 检测来捕获由 [CrewAI](https://github.com/crewAIInc/crewAI) 生成的追踪。本指南将向您展示如何自动捕获 CrewAI 多智能体工作流的追踪，并将其发送到 LangSmith 进行监控和分析。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/langsmith/trace-with-crewai.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>