...
VFS 沙盒使用内存中的虚拟文件系统完全在本地运行。无需云服务、Docker 或外部依赖项——非常适合开发和测试。
...
此包使用 [node-vfs-polyfill](https://github.com/vercel-labs/node-vfs-polyfill)，它实现了 [nodejs/node#61478](https://github.com/nodejs/node/pull/61478) 中正在开发的即将推出的 Node.js VFS 功能。当官方 `node:vfs` 模块在 Node.js 中发布时，此包将更新以使用原生实现。

---

<div className="source-links">
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/providers/node-vfs.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
