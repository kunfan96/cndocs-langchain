...
Hyperbrowser 提供了两个主要类别的工具，特别适用于：
- 从复杂网站进行网页抓取和数据提取
- 自动化重复性网页任务
- 与需要身份验证的 Web 应用程序交互
- 跨多个网站进行研究
...
Hyperbrowser 提供了多个浏览器代理工具。目前我们支持：
 - Claude Computer Use
 - OpenAI CUA
 - Browser Use

您可以在 [Hyperbrowser 浏览器代理工具指南](/oss/python/integrations/tools/hyperbrowser_browser_agent_tools) 中查看更多详情。
...
以下是 Hyperbrowser 提供的网页抓取工具的简要描述。您可以在 [Hyperbrowser 网页抓取工具指南](/oss/python/integrations/tools/hyperbrowser_web_scraping_tools) 中查看更多详情。
...
#### Crawl 工具
Crawl 工具使您能够从给定的 URL 开始遍历整个网站，并可配置页面限制。
...
`langchain-hyperbrowser` 中的 `HyperbrowserLoader` 类可以轻松用于从任何单个页面或多个页面加载内容，以及爬取整个网站。
