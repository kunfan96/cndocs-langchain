---
title: "Exa 集成"
description: "使用 LangChain Python 与 Exa 集成。"
---
...
`Exa` 集成存在于其独立的[合作伙伴包](https://pypi.org/project/langchain-exa/)中。你可以使用以下命令安装：
...
你可以在标准检索管道中使用 [`ExaSearchRetriever`](/oss/python/integrations/tools/exa_search#using-exasearchretriever)。导入方式如下。

查看[使用示例](/oss/python/integrations/tools/exa_search)。
...
你可以按照 [Exa 工具调用文档](/oss/python/integrations/tools/exa_search#use-within-an-agent) 中的描述将 Exa 用作代理工具。
