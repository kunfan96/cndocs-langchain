...
title: "沙盒集成"
sidebarTitle: 沙盒
description: "使用 LangChain JavaScript 与沙盒提供商集成。"
---

沙盒提供隔离的执行环境，用于安全运行代理生成的代码。了解更多关于[沙盒](/oss/javascript/deepagents/sandboxes)的信息。
...
如果您想贡献一个沙盒，请参阅[实现沙盒集成](/oss/javascript/contributing/implement-langchain#sandboxes)。

---

<div className="source-links">
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/sandboxes/index.mdx) 或[提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
