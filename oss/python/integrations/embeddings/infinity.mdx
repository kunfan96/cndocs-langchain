---
title: "Infinity 集成"
description: "使用 LangChain Python 与 Infinity 嵌入模型集成。"
---

`Infinity` 允许使用 MIT 许可的嵌入服务器创建 [`嵌入`](https://reference.langchain.com/python/langchain-core/embeddings/embeddings/Embeddings)。

本笔记本介绍如何使用 LangChain 与 [Infinity GitHub 项目](https://github.com/michaelfeil/infinity) 的嵌入功能。
...
启动服务器 - 最好从单独的终端执行，而不是在 Jupyter Notebook 内部
