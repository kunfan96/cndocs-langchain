...
description: "使用 LangChain JavaScript 与 LangSmithLoader 文档加载器集成。"
---

本笔记本提供了快速入门 `LangSmithLoader` [文档加载器](/oss/javascript/integrations/document_loaders/) 的概览。有关所有 `LangSmithLoader` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-core/document_loaders/langsmith/LangSmithLoader)。
...
有关所有 `LangSmithLoader` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-core/document_loaders/langsmith/LangSmithLoader)
