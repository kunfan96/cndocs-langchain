...
这将帮助您开始使用 Egnyte [检索器](/oss/python/langchain/retrieval)。有关所有 `EgnyteRetriever` 功能和配置的详细文档，请访问 [API 参考](https://github.com/egnyte/egnyte-langchain-connector)。
...
* 一个 Egnyte 账户 — 如果您不是当前的 Egnyte 客户，或者想在您的生产 Egnyte 实例之外进行测试，您可以使用 [免费开发者账户](https://developers.egnyte.com/member/register)。
* 一个 Egnyte 应用 — 这在 [开发者控制台](https://developers.egnyte.com/) 中配置，并且必须启用适当的权限范围。
* 该应用必须由管理员启用。对于免费开发者账户，管理员就是注册该账户的人。
...
如果您想从单个查询中获得自动跟踪，也可以通过取消注释下方内容来设置您的 [LangSmith](https://docs.smith.langchain.com/) API 密钥：
...
如果您有任何问题，请查看 [Egnyte 开发者文档](https://developers.egnyte.com/) 或联系 Egnyte 开发者社区。
