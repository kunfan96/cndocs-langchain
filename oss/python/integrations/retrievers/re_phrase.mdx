...
description: "使用 LangChain Python 集成 RephraseQuery 检索器。"
---

`RePhraseQuery` 是一个简单的检索器，它在用户输入和检索器传递的查询之间应用一个 LLM。

它可以用于以任意方式对用户输入进行预处理。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/re_phrase.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
