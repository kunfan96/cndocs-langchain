...
人类是通用人工智能（AGI），因此当然可以被用作工具，在人工智能智能体感到困惑时提供帮助。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/tools/human_tools.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>