---
title: "Comet 集成"
description: "使用 LangChain Python 与 Comet 进行集成。"
---

>[Comet](https://www.comet.com/) 机器学习平台与您现有的基础设施
>和工具集成，使您能够管理、可视化和优化模型——从训练运行到生产监控
...
运行以下示例需要 [OpenAI API Key](https://platform.openai.com/account/api-keys) 和 [SerpApi API Key](https://serpapi.com/dashboard)。
...
在下方的代码片段中，我们将使用 [ROUGE](https://huggingface.co/spaces/evaluate-metric/rouge) 指标来评估输入提示词所生成摘要的质量。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/comet_tracking.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
