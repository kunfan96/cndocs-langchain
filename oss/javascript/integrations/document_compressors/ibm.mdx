...
这将帮助您开始使用 Watsonx [文档压缩器](/oss/javascript/concepts/#document_compressors)。有关所有 Watsonx 文档压缩器功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-community/document_compressors/ibm/WatsonxRerank)。
...
首先，使用嵌入、文本分割器和向量存储设置一个基本的 RAG 提取管道。我们将使用它来对所选查询的一些文档进行重新排序：
...
或者，您可以使用 `.compressDocuments()` 方法让文档随结果一起返回，如下所示。
...
有关所有 Watsonx 文档压缩器功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-community/document_compressors/ibm/WatsonxRerank)。
