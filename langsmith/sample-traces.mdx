...
采样提供了对追踪量的**概率性**控制，而[条件追踪](/langsmith/conditional-tracing)则基于业务逻辑提供**确定性**控制。

当您希望在保持应用行为统计代表性的同时减少整体追踪量时，请使用**采样**。

当您需要对特定请求保证追踪行为时，请使用[条件追踪](/langsmith/conditional-tracing)，例如：
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/langsmith/sample-traces.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>