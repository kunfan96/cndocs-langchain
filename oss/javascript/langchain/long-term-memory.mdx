...
LangChain agents 使用 [LangGraph persistence](/oss/javascript/langgraph/persistence#memory-store) 来启用长期记忆。这是一个更高级的主题，需要了解 LangGraph 才能使用。
...
有关记忆存储的更多信息，请参阅 [Persistence](/oss/javascript/langgraph/persistence#memory-store) 指南。
