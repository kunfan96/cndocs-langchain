---
title: "金融数据集工具包集成"
description: "使用 LangChain Python 集成金融数据集工具包。"
---

[金融数据集](https://financialdatasets.ai/) 股票市场 API 提供 REST 端点，可获取涵盖 30 多年、16,000 多支股票代码的财务数据。
...
让我们为代理配备 FinancialDatasetsToolkit 并提出财务问题。
...
有关所有 `FinancialDatasetsToolkit` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/python/langchain-community/agent_toolkits/financial_datasets/toolkit/FinancialDatasetsToolkit)。
