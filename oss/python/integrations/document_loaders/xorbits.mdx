---
title: "Xorbits Pandas DataFrame 集成"
description: "使用 LangChain Python 集成 Xorbits Pandas DataFrame 文档加载器。"
---

本笔记本介绍如何从 [xorbits.pandas](https://doc.xorbits.io/en/latest/reference/pandas/frame.html) DataFrame 加载数据。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/xorbits.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
