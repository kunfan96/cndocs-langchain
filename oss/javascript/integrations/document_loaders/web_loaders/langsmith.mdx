...
description: "使用 LangChain JavaScript 与 LangSmithLoader 文档加载器进行集成。"
---


本笔记本提供了快速入门 `LangSmithLoader` [文档加载器](/oss/javascript/integrations/document_loaders/) 的概述。有关所有 `LangSmithLoader` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-core/document_loaders/langsmith/LangSmithLoader)。

## 概述

### 集成详情

| 类 | 包 | 本地 | 可序列化 | [PY 支持](https://python.langchain.com/docs/integrations/document_loaders/langsmith)|
| :--- | :--- | :---: | :---: |  :---: |
...
在 [langsmith.com](https://langsmith.com) 注册并生成 API 密钥。完成此操作后，设置 `LANGSMITH_API_KEY` 环境变量：
...
在此示例中，我们将创建一个新数据集，该数据集将在我们的文档加载器中使用。
...
有关所有 `LangSmithLoader` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-core/document_loaders/langsmith/LangSmithLoader)

---

<div className="source-links">
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/document_loaders/web_loaders/langsmith.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
