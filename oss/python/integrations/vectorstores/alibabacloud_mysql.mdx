...
>[阿里云 MySQL](https://www.alibabacloud.com/product/apsaradb-for-rds-mysql) 是一种完全托管的关系型数据库服务，提供高可用性、可扩展性和安全性。
...
本指南提供了 alibabacloud-mysql [向量存储](/oss/python/integrations/vectorstores#overview) 的快速入门概览。如需了解 alibabacloud-mysql 向量存储的所有功能、参数和配置的详细说明，请访问 [langchain-alibabacloud-mysql](https://github.com/wangkuahai/langchain-alibabacloud-mysql)。

## 配置

要访问 alibabacloud-mysql 向量存储，您需要[创建小版本为 8.0.36 或更高版本的阿里云 RDS MySQL 实例](https://www.alibabacloud.com/help/en/rds/apsaradb-rds-for-mysql/step-1-create-an-apsaradb-rds-for-mysql-instance-and-configure-databases)，[开启向量功能](https://www.alibabacloud.com/help/en/rds/apsaradb-rds-for-mysql/vector-storage-1#:~:text=restarting%20the%20instance.-,Enable%20and%20use%20the%20feature,-Note)，[配置访问权限](https://www.alibabacloud.com/help/en/rds/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance)，并安装 `langchain-alibabacloud-mysql` 集成包。
...
如果您选择使用 DashScope 模型，可以在[此处](https://modelstudio.console.aliyun.com/?tab=dashboard#/api-key)获取 API Key，并在以下代码中设置。
</Note>
...
我们将很快更新 API 参考文档，更多详情请参阅 [langchain-alibabacloud-mysql](https://github.com/wangkuahai/langchain-alibabacloud-mysql)。
