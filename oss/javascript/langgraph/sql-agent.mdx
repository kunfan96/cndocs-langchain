...
- [Human in the Loop](/oss/javascript/langgraph/interrupts)流程
...
<Tip>
  ...
  跟踪](https://smith.langchain.com/public/a6a96896-686a-4040-b9b5-28d701453d6f/r)。
</Tip>
...
在这里，我们利用 LangGraph 的[Human in the Loop](/oss/javascript/langgraph/interrupts)功能，在执行 SQL 查询之前暂停运行并等待人工审查。使用 LangGraph 的[持久化层](/oss/javascript/langgraph/persistence)，我们可以无限期地暂停运行（或至少在持久化层存活期间）。
...
<Note>
  上述实现遵循了更广泛的[Human in the
  Loop](/oss/javascript/langgraph/interrupts)指南中的[工具中断示例](/oss/javascript/langgraph/interrupts#interrupts-in-tools)。有关详细信息和替代方案，请参阅该指南。
</Note>
...
有关详细信息，请参阅[Human in the Loop指南](/oss/javascript/langgraph/interrupts)。
...
<div className="source-links">
  ...
  <Callout icon="edit">
    [在 GitHub
    上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/langgraph/sql-agent.mdx)
