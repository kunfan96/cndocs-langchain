...
description: "使用 LangChain Python 与 ChatTogether 聊天模型进行集成。"
---


本页面将帮助您开始使用 Together AI [聊天模型](/oss/python/langchain/models)。有关所有 `ChatTogether` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/python/langchain-together/chat_models/ChatTogether)。
