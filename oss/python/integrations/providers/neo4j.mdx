...
LangGraph 检查点保存器的 Neo4j 实现，用于支持分支时间旅行的持久化 GitHub 代理记忆。检查点保存器在每个超级步骤持久化图状态，从而实现会话记忆、Human in the Loop工作流、时间旅行和容错。
...
<div className="source-links">
  ...
  <Callout icon="edit">
    [在 GitHub
    上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/neo4j.mdx)
