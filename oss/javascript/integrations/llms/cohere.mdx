---
title: "Cohere 集成"
description: "使用 LangChain JavaScript 与 Cohere LLM 集成。"
---

<Warning>
**旧版**

Cohere 已将其 LLM 的 `generate` 端点标记为已弃用。请遵循其[迁移指南](https://docs.cohere.com/docs/migrating-from-cogenerate-to-cochat)，开始通过 [`ChatCohere`](/oss/javascript/integrations/chat/cohere) 集成使用其 Chat API。
</Warning>

本文档将帮助您开始使用 LangChain 的 Cohere 补全模型（LLM）。有关 `Cohere` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-cohere/Cohere)。
