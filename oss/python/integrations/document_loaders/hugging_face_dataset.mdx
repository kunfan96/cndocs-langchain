...
description: "使用 LangChain Python 集成 HuggingFace 数据集文档加载器。"
---

>[Hugging Face Hub](https://huggingface.co/docs/hub/index) 拥有超过 5,000 个[数据集](https://huggingface.co/docs/hub/index#datasets)，涵盖 100 多种语言，可用于 NLP、计算机视觉和音频等领域的广泛任务，包括翻译、自动语音识别和图像分类等多种任务。

本笔记本介绍如何将 `Hugging Face Hub` 数据集加载到 LangChain。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/hugging_face_dataset.mdx) 或[提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
