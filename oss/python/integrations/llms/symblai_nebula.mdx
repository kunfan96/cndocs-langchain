...
[Nebula](https://symbl.ai/nebula/) 是由 [Symbl.ai](https://symbl.ai) 构建的大型语言模型 (LLM)。它经过训练，可在人类对话上执行生成式任务。Nebula 擅长建模对话的细微细节，并在对话上执行任务。
...
请确保您拥有 API 密钥。如果您没有，请[申请一个](https://info.symbl.ai/Nebula_Private_Beta.html)。
