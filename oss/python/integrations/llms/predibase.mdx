---
title: "Predibase 集成"
description: "使用 LangChain Python 集成 Predibase LLM。"
---

[Predibase](https://predibase.com/) 允许您训练、微调和部署任何 ML 模型——从线性回归到大型语言模型。

本示例演示如何将 LangChain 与部署在 Predibase 上的模型配合使用。

# 设置

运行本 notebook 需要 [Predibase 账户](https://predibase.com/free-trial/?utm_source=langchain)和 [API 密钥](https://docs.predibase.com/sdk-guide/intro)。

还需要安装 Predibase Python 包：
...
## 微调 LLM（使用您在 Predibase 上的自定义微调 LLM）
