---
title: "ChatYi 集成"
description: "使用 LangChain Python 与 ChatYi 聊天模型集成。"
---

这将帮助您开始使用 Yi [聊天模型](/oss/python/langchain/models)。
...
| [工具调用](/oss/python/langchain/tools) | [结构化输出](/oss/python/langchain/structured-output) | [图像输入](/oss/python/langchain/messages#multimodal) | 音频输入 | 视频输入 | [Token 级流式传输](/oss/python/langchain/streaming/) | 原生异步 | [Token 使用](/oss/python/langchain/models#token-usage) | [Logprobs](/oss/python/langchain/models#log-probabilities) |
| :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: | :---: |
| ❌ | ❌ | ✅ | ❌ | ❌ | ✅ | ❌ | ✅ | ❌ |
...
前往 [01.AI](https://platform.01.ai) 注册 01.AI 并生成 API 密钥。完成后，设置 `YI_API_KEY` 环境变量：
