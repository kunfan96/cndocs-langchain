...
请查阅 [Airbyte 文档页面](https://docs.airbyte.com/integrations/sources/zendesk-support/) 以获取有关如何配置读取器的详细信息。
...
由于 `load` 返回一个列表，它将阻塞直到所有文档加载完毕。为了更好地控制此过程，您也可以使用返回迭代器的 `lazy_load` 方法：
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/airbyte_zendesk_support.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>