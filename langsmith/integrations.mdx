...
[LangSmith](https://smith.langchain.com/) 为不断增长的流行 [LLM 提供商](#llm-providers) 和 [代理框架](#agent-frameworks) 以及 [Deep Agents](/oss/python/deepagents/overview)、[LangChain](/oss/python/langchain/overview) 和 [LangGraph](/oss/python/langgraph/overview) 提供集成。有关设置和使用方法，请参阅本页列出的指南。
...
**正在使用 LangChain？** LangChain 提供了一个统一的接口，可连接 100 多个 LLM 提供商，允许您通过设置环境变量在模型之间切换。[初始化模型](/oss/python/langchain/models#initialize-a-model)，LangSmith 将自动追踪您的应用程序。
</Callout>
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/langsmith/integrations.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>