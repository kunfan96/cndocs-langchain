---
title: "ChatGPT 插件集成"
description: "使用 LangChain JavaScript 与 ChatGPT 插件工具集成。"
---
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/tools/aiplugin-tool.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
