...
description: "使用 LangChain JavaScript 与 OllamaEmbeddings 嵌入模型进行集成。"
---

本文档将帮助您开始使用 LangChain 的 Ollama [嵌入模型](/oss/javascript/integrations/embeddings)。有关 `OllamaEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-ollama/OllamaEmbeddings)。

## 概述

### 集成详情

| 类 | 包 | 本地 | [Python 支持](https://python.langchain.com/docs/integrations/embeddings/ollama/) | 下载量 | 版本 |
| :--- | :--- | :---: | :---: |  :---: | :---: |
...
Ollama [模型参数](https://github.com/jmorganca/ollama/blob/main/docs/modelfile.md#valid-parameters-and-values) 也受支持：
...
有关所有 `OllamaEmbeddings` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-ollama/OllamaEmbeddings)

---

<div className="source-links">
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/embeddings/ollama.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
