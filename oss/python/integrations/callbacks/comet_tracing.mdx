...
有两种方法可以追踪您的 LangChain 执行过程与 Comet：
...
```python
# 带追踪的代理运行。确保已适当设置 OPENAI_API_KEY 以运行此示例。
...
agent.invoke("What is 2 raised to .123243 power?")  # 这应该会被追踪
# 一个类似以下的链 URL 应该会打印在您的控制台中：
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/callbacks/comet_tracing.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>