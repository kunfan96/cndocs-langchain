---
title: "Polars DataFrame 集成"
description: "使用 LangChain Python 与 Polars DataFrame 文档加载器集成。"
---

本笔记本介绍如何从 [polars](https://pola-rs.github.io/polars-book/user-guide/) DataFrame 加载数据。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/polars_dataframe.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
