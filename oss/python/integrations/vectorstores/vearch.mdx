---
title: "Vearch 集成"
description: "使用 LangChain Python 与 Vearch 向量存储进行集成。"
---
...
请遵循[说明](https://vearch.readthedocs.io/en/latest/quick-start-guide.html#)。
...
# 向量数据通常已初始化，因此我们不需要文档参数，可以直接创建对象。
...
# 在实际应用中，我们通常限制相似度的边界值。以下方法可以设置此值。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/vectorstores/vearch.mdx) 或[提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
