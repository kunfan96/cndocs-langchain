...
<Note>
  取消队列条目仅影响**尚未开始处理**的消息。如果代理已经在处理某条消息，从队列中取消它不会产生任何效果。请使用
  `stream.stop()` 来中断当前运行。
</Note>
...
<div className="source-links">
  <Callout icon="edit">
    [在 GitHub
    上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/frontend/message-queues.mdx)
