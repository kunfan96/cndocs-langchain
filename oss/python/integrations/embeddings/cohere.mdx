...
description: "使用 LangChain Python 与 CohereEmbeddings 嵌入模型进行集成。"
---

本文档将帮助您开始使用 LangChain 集成 Cohere 嵌入模型。有关 `CohereEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-cohere/embeddings/CohereEmbeddings)。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/embeddings/cohere.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
