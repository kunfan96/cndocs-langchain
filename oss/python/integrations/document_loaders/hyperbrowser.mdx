...
description: "使用 LangChain Python 与 HyperbrowserLoader 文档加载器进行集成。"
---

[Hyperbrowser](https://hyperbrowser.ai) 是一个用于运行和扩展无头浏览器的平台。它允许您大规模启动和管理浏览器会话，并为任何网络抓取需求提供易于使用的解决方案，例如抓取单个页面或爬取整个网站。
...
本指南提供了快速入门 `HyperbrowserLoader` [文档加载器](https://python.langchain.com/docs/concepts/#document-loaders) 的概述。
