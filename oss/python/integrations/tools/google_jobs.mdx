---
title: "Google 招聘信息集成"
description: "使用 LangChain Python 集成 Google 招聘信息工具。"
---

本笔记本介绍如何使用 Google Jobs 工具获取当前职位发布信息。

首先，您需要在以下地址注册获取 `SerpApi key`：[serpapi.com/users/sign_up](https://serpapi.com/users/sign_up)，并在此处获取您的 API 密钥：[serpapi.com/manage-api-key](https://serpapi.com/manage-api-key)。

然后使用以下命令安装 `google-search-results`：
    `pip install google-search-results`

然后将环境变量 `SERPAPI_API_KEY` 设置为您的 `SerpApi key`
...
要创建使用 Google Jobs 工具的 Agent，请安装 LangGraph
