...
检索器可以从向量存储创建，但也足够广泛以包括[Wikipedia搜索](/oss/python/integrations/retrievers/wikipedia/)和[Amazon Kendra](/oss/python/integrations/retrievers/amazon_kendra_retriever/)。
