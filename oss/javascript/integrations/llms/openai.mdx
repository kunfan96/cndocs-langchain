...
<Warning>
**您当前正在查看的是关于使用 OpenAI 文本补全模型的文档。最新且最受欢迎的 OpenAI 模型是[聊天补全模型](/oss/javascript/langchain/models)。**

除非您特别使用 `gpt-3.5-turbo-instruct`，否则您可能需要的是[此页面](/oss/javascript/integrations/chat/openai/)。
</Warning>

[OpenAI](https://en.wikipedia.org/wiki/OpenAI) 是一个人工智能（AI）研究实验室。

本文将帮助您开始使用 LangChain 的 OpenAI 补全模型（大语言模型）。有关 OpenAI 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-openai/OpenAI)。
...
如果您托管在 Azure OpenAI 上，请参阅[专用页面](/oss/javascript/integrations/llms/azure)。

---

## API 参考

有关所有 `OpenAI` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-openai/OpenAI)。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/llms/openai.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>