---
title: "RSS 订阅集成"
description: "使用 LangChain Python 集成 RSS 订阅文档加载器。"
---

本文介绍如何从一组 RSS 订阅 URL 中加载 HTML 新闻文章，并将其转换为可在后续流程中使用的文档格式。
...
您可以向 NewsURLLoader 传递参数，以自定义文章的加载方式。
...
您还可以使用 OPML 文件，例如 Feedly 的导出文件。传入 URL 或 OPML 内容均可。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/rss.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
