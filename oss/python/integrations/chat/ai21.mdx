...
本 notebook 涵盖如何开始使用 AI21 聊天模型。
请注意，不同的聊天模型支持不同的参数。请参阅 [AI21 文档](https://docs.ai21.com/reference) 以了解更多关于所选模型参数的信息。
...
| :--- | :--- | :---: |  :---: | :---: | :---: |
| `ChatAI21` | `langchain-ai21` | beta | ✅ | ![PyPI - 下载量](https://img.shields.io/pypi/dm/langchain-ai21?style=flat-square&label=%20) | ![PyPI - 版本](https://img.shields.io/pypi/v/langchain-ai21?style=flat-square&label=%20) |
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/chat/ai21.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
