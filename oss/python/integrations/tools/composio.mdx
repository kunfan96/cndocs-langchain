...
[Composio](https://composio.dev) 是一个集成平台，提供对 GitHub、Slack、Notion 等流行应用程序中 500 多种工具的访问。它使 AI 代理能够通过统一的 API 与外部服务交互，处理身份验证、权限和事件驱动工作流。
...
- **500 多种工具访问**：为 GitHub、Slack、Gmail、Jira、Notion 等提供预构建集成
...
以下是使用 Composio 工具与 LangChain 代理交互以与 GitHub 交互的完整示例：
