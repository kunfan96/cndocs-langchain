...
- **Human in the Loop和中断**：代理可以在[中断](/langsmith/add-human-in-the-loop)处暂停以获取人类输入。取消运行会停止执行；这与中断不同，中断是运行暂停，可以通过新输入恢复。
...
<div className="source-links">
  ...
  <Callout icon="edit">
    [在 GitHub
    上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/langsmith/cancel-run.mdx)
