---
title: "RSS订阅源集成"
description: "使用LangChain Python集成RSS订阅源文档加载器。"
---

本文介绍如何将HTML新闻文章从一系列RSS订阅源URL加载到文档格式中，以便后续使用。
...
你可以向NewsURLLoader传递参数，它将使用这些参数来加载文章。
...
你也可以使用OPML文件，例如Feedly导出的文件。传入URL或OPML内容均可。
...
<Callout icon="edit">
    [在GitHub上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/rss.mdx)或[提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>