...
description: "使用 LangChain Python 与 Google Finance 工具集成。"
---

本笔记本介绍如何使用 Google Finance 工具从 Google Finance 页面获取信息。

要获取 SerpApi 密钥，请在此注册：[serpapi.com/users/sign_up](https://serpapi.com/users/sign_up)。

要使用 LangChain 的该工具，请安装以下包
...
为了创建一个使用 Google Finance 工具的代理，请安装 LangGraph
