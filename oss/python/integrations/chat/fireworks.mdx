...
description: "使用 LangChain Python 与 ChatFireworks 聊天模型集成。"
---

本文档帮助您开始使用 Fireworks AI [聊天模型](/oss/python/langchain/models)。有关 Fireworks 提供的所有模型列表，请参阅 [Fireworks 文档](https://fireworks.ai/models)。

<Tip>
    **API 参考**

    有关所有功能和配置选项的详细文档，请访问 [`ChatFireworks`](https://reference.langchain.com/python/langchain-fireworks/chat_models/ChatFireworks) API 参考。
</Tip>
