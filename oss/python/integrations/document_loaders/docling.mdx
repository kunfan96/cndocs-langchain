...
[Docling](https://github.com/DS4SD/docling) 将 PDF、DOCX、PPTX、HTML 和其他格式解析为丰富的统一表示，包括文档布局、表格等，使其为 RAG 等生成式 AI 工作流做好准备。
...
> 注意：在这种情况下，可以忽略显示 `"Token indices sequence length is longer than the specified maximum sequence length..."` 的消息——更多详情请参阅此 [docling-core GitHub issue](https://github.com/DS4SD/docling-core/issues/119#issuecomment-2577418826)。
