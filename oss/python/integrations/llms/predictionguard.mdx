...
description: "使用 LangChain Python 与 Predictionguard LLM 集成。"
---
...
此集成利用了 Prediction Guard API，该 API 包含各种安全防护和安全功能。
...
使用 Prediction Guard，您可以使用事实性检查来验证模型输出，以防范幻觉和错误信息，并使用毒性检查来防范有毒响应（例如脏话、仇恨言论）。更多信息请参阅 [Prediction Guard 文档](https://docs.predictionguard.com/docs/validating-llm-output)。
