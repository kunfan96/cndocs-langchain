---
title: "PubMed 集成"
description: "使用 LangChain Python 集成 PubMed 工具。"
---

>[PubMed®](https://pubmed.ncbi.nlm.nih.gov/) 收录了来自 `MEDLINE`、生命科学期刊和在线图书的超过 3500 万条生物医学文献引用。这些引用可能包含来自 PubMed Central 和出版商网站的全文内容链接。

本 notebook 介绍如何将 `PubMed` 作为工具使用。
