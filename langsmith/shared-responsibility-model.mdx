...
sidebarTitle: 共享责任模型
description: 概述 LangChain 与客户如何共同承担 LangSmith 平台的安全责任。
---
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/langsmith/shared-responsibility-model.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>