...
sidebarTitle: "嵌入"
description: "使用 LangChain JavaScript 与 GoogleGenerativeAIEmbeddings 嵌入模型集成。"
---

本文档将帮助您开始使用 LangChain 的 Google Generative AI [嵌入模型](/oss/javascript/integrations/embeddings)。有关 `GoogleGenerativeAIEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-google-genai/GoogleGenerativeAIEmbeddings)。

## 概述

### 集成详情

| 类 | 包 | 本地 | [Python 支持](https://python.langchain.com/docs/integrations/embeddings/google_generative_ai/) | 下载量 | 版本 |
| :--- | :--- | :---: | :---: |  :---: | :---: |
...
要访问 Google Generative AI 嵌入模型，您需要注册一个 Google AI 账户、获取 API 密钥，并安装 `@langchain/google-genai` 集成包。
...
LangChain `GoogleGenerativeAIEmbeddings` 集成位于 `@langchain/google-genai` 包中。您可能还需要安装官方 SDK：
...
有关所有 `GoogleGenerativeAIEmbeddings` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-google-genai/GoogleGenerativeAIEmbeddings)。

---

<div className="source-links">
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/embeddings/google_generative_ai.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
