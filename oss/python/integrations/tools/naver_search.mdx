---
title: "Naver 搜索集成"
description: "使用 LangChain Python 集成 Naver 搜索工具。"
---

Naver 搜索工具提供了一个简单的接口，用于搜索 Naver 并获取结果。
...
**搜索**：Naver 搜索工具提供了一个简单的接口，用于搜索 Naver 并获取结果。

## 设置

### 设置 API 凭证

要使用 Naver Search，您需要获取 API 凭证。请按照以下步骤操作：
...
Naver 搜索工具可以集成到 LangChain 智能体中以完成更复杂的任务。以下我们演示如何设置一个可以搜索 Naver 以获取当前信息的智能体。
