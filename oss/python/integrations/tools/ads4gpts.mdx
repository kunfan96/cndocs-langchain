...
将 AI 原生广告集成到您的 Agent 应用中。

## 概述

本 notebook 介绍如何在 LangChain 中直接使用 ADS4GPTs 工具和工具包。不过，在您的 LangGraph 应用中，您最可能使用我们预构建的 LangGraph agents。
...
设置 API 认证所需的环境变量（[获取 API Key](https://www.ads4gpts.com)）。
...
初始化 ADS4GPTs 工具，例如 Ads4gptsInlineSponsoredResponseTool。我们将使用一个工具进行演示，其他工具的使用方式与此相同。
...
您可以在我们的 [GitHub](https://github.com/ADS4GPTs/ads4gpts/tree/main) 上了解更多关于 ADS4GPTs 和相关工具的信息。
