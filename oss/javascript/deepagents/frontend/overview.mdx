...
<CardGroup cols={3}>
  <Card
    title="子代理流"
    icon="arrows-split"
    href="/oss/javascript/deepagents/frontend/subagent-streaming"
  >
  ...
  <Card
    title="待办事项列表"
    icon="list-check"
    href="/oss/javascript/deepagents/frontend/todo-list"
  >
  ...
  <Card
    title="沙盒"
    icon="code"
    href="/oss/javascript/deepagents/frontend/sandbox"
  >
