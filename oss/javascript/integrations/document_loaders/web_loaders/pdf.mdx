...
本笔记本提供了快速入门 `WebPDFLoader` [文档加载器](/oss/javascript/integrations/document_loaders/) 的概览。有关所有 `WebPDFLoader` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-community/document_loaders/web/pdf/WebPDFLoader)。
...
默认情况下，PDF 文件中的每一页将创建一个文档，您可以通过将 `splitPages` 选项设置为 `false` 来更改此行为。
...
有关所有 `WebPDFLoader` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-community/document_loaders/web/pdf/WebPDFLoader)。
