...
> [Polaris AI DataInsight](https://datainsight.polarisoffice.com/playground) 是一款文档解析器，
> 可从各种文件格式中提取文档元素（文本、图片、复杂表格、图表等），
> 并将其转换为结构化 JSON，方便集成到 RAG 系统中。
