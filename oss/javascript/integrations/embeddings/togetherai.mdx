...
description: "使用 LangChain JavaScript 与 TogetherAIEmbeddings 嵌入模型进行集成。"
---

本文档将帮助您开始使用 LangChain 集成 TogetherAIEmbeddings [嵌入模型](/oss/javascript/integrations/embeddings)。有关 `TogetherAIEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-community/embeddings/togetherai/TogetherAIEmbeddings)。
...
有关所有 `TogetherAIEmbeddings` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-community/embeddings/togetherai/TogetherAIEmbeddings)。
