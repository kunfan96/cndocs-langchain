---
title: "Clarifai 集成"
description: "使用 LangChain Python 与 Clarifai LLM 集成。"
---

>[Clarifai](https://www.clarifai.com/) 是一个 AI 平台，提供完整的 AI 生命周期，涵盖数据探索、数据标注、模型训练、评估和推理。
...
# 您可以提供特定的模型版本作为 model_version_id 参数。
