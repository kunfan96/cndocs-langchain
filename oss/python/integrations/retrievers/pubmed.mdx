---
title: "PubMed 集成"
description: "使用 LangChain Python 集成 PubMed 检索器。"
---

>[PubMed®](https://pubmed.ncbi.nlm.nih.gov/) 由美国国家生物技术信息中心（National Center for Biotechnology Information）和美国国家医学图书馆（National Library of Medicine）运营，收录了来自 `MEDLINE`、生命科学期刊及在线书籍的超过 3500 万条生物医学文献引用。引用内容可能包含指向 `PubMed Central` 和出版商网站的全文链接。

本 notebook 介绍如何将 `PubMed` 用作检索器。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/pubmed.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
