...
[Cerebras](https://cerebras.ai/) 是一家模型提供商，专注于提供强调速度的开源模型。Cerebras CS-3 系统由晶圆级引擎-3 (WSE-3) 驱动，代表了一类新型的 AI 超级计算机，以其无与伦比的性能和可扩展性为生成式 AI 训练和推理树立了标准。
...
这将帮助您开始使用 `ChatCerebras` [聊天模型](/oss/javascript/langchain/models)。有关所有 `ChatCerebras` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-cerebras/ChatCerebras)。
...
有关所有 `ChatCerebras` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-cerebras/ChatCerebras)。
