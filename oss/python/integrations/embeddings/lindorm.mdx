...
这将帮助你开始使用 LangChain 集成 Lindorm 嵌入模型。
...
你可以在[控制台](https://lindorm.console.aliyun.com/cn-hangzhou/clusterhou/cluster?spm=a2c4g.11186623.0.0.466534e93Xj6tt)获取你的凭证。
...
class Config:
    ...
    AI_DEFAULT_EMBEDDING_MODEL = "bge_m3_model"  # 设置为你部署的模型
```

### 安装

LangChain Lindorm 集成包位于 `langchain-lindorm-integration` 包中：
