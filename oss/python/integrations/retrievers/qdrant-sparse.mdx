---
title: "Qdrant 稀疏向量集成"
description: "使用 LangChain Python 集成 Qdrant 稀疏向量检索器。"
---

>[Qdrant](https://qdrant.tech/) 是一个开源的高性能向量搜索引擎/数据库。

>`QdrantSparseVectorRetriever` 使用 `Qdrant` [v1.7.0](https://qdrant.tech/articles/qdrant-1.7.x/) 引入的[稀疏向量](https://qdrant.tech/articles/sparse-vectors/)进行文档检索。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/qdrant-sparse.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
