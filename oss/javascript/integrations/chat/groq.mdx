...
[Groq](https://groq.com/) 是一家提供快速 AI 推理的公司，其 LPU™ AI 推理技术可提供快速、经济且节能的 AI。

这将帮助您开始使用 Groq [聊天模型](/oss/javascript/langchain/models)。有关所有 `ChatGroq` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-groq/ChatGroq)。

## 概述

### 集成详情

| 类 | 包 | 可序列化 | [PY 支持](https://python.langchain.com/docs/integrations/chat/groq) | 下载量 | 版本 |
| :--- | :--- | :---: |  :---: | :---: | :---: |
