---
title: "Tablestore 集成"
description: "使用 LangChain Python 集成 Tablestore 向量存储。"
---

[Tablestore](https://www.aliyun.com/product/ots) 是一款全托管的 NoSQL 云数据库服务。

Tablestore 支持存储海量结构化和半结构化数据。

本笔记本演示如何使用 `Tablestore` 向量数据库的相关功能。

使用 Tablestore 前，必须先创建一个实例。
