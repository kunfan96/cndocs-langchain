---
title: "TypeORM 集成"
description: "使用 LangChain JavaScript 与 TypeORM 向量存储集成。"
---

要在通用的 PostgreSQL 数据库中启用向量搜索，LangChain.js 支持使用 [TypeORM](https://typeorm.io/) 配合 [`pgvector`](https://github.com/pgvector/pgvector) Postgres 扩展。
