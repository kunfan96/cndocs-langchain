---
title: "OpenAI 集成"
description: "使用 LangChain JavaScript 与 OpenAI LLM 集成。"
---

<Warning>
**您当前正在查看的页面记录了 OpenAI 文本补全模型的使用。最新且最受欢迎的 OpenAI 模型是[聊天补全模型](/oss/javascript/langchain/models)。**

除非您特别使用 `gpt-3.5-turbo-instruct`，否则您可能正在寻找[此页面](/oss/javascript/integrations/chat/openai/)。
</Warning>

[OpenAI](https://en.wikipedia.org/wiki/OpenAI) 是一个人工智能（AI）研究实验室。

这将帮助您开始使用 LangChain 的 OpenAI 补全模型（LLM）。有关 OpenAI 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-openai/OpenAI)。
...
有关所有 `OpenAI` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-openai/OpenAI)。
