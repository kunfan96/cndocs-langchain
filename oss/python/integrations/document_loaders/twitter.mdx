---
title: "Twitter 集成"
description: "使用 LangChain Python 集成 Twitter 文档加载器。"
---

>[Twitter](https://twitter.com/) 是一个在线社交媒体和社交网络服务平台。

该加载器使用 `tweepy` Python 包，从指定 `Twitter` 用户的推文中获取文本内容。您需要使用 `Twitter API` 令牌初始化加载器，并传入要提取的 Twitter 用户名。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/twitter.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
