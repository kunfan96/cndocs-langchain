---
title: "Lantern 集成"
description: "使用 LangChain Python 集成 Lantern 向量存储。"
---

>[Lantern](https://github.com/lanterndata/lantern) 是一款用于 `Postgres` 的开源向量相似度搜索工具
...
最大边际相关性在优化与查询相似性的同时，也兼顾所选文档的多样性。
