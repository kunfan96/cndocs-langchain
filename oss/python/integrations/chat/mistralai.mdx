...
与 API 通信需要有效的 [API 密钥](https://console.mistral.ai/api-keys/)。完成此操作后，设置 MISTRAL_API_KEY 环境变量：
...
访问 [API 参考](https://reference.langchain.com/python/langchain-mistralai/chat_models/ChatMistralAI) 获取所有属性和方法的详细文档。
