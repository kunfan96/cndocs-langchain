...
`Exa` 集成存在于其独立的[合作伙伴包](https://pypi.org/project/langchain-exa/)中。你可以通过以下方式安装：
...
你可以在标准的检索管道中使用 [`ExaSearchRetriever`](/oss/python/integrations/tools/exa_search#using-exasearchretriever)。你可以按如下方式导入它。

参见[使用示例](/oss/python/integrations/tools/exa_search)。
...
你可以将 Exa 用作代理工具，如 [Exa 工具调用文档](/oss/python/integrations/tools/exa_search#use-within-an-agent)中所述。
