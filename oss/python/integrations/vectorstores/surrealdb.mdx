...
您可以本地运行 SurrealDB，或从 [免费的 SurrealDB 云账户](https://surrealdb.com/docs/cloud/getting-started) 开始。

对于本地运行，有两种选择：

1. [安装 SurrealDB](https://surrealdb.com/docs/surrealdb/installation) 并 [运行 SurrealDB](https://surrealdb.com/docs/surrealdb/installation/running)。使用以下命令以内存模式运行：
...
- [Awesome SurrealDB](https://github.com/surrealdb/awesome-surreal)，一个精选的 SurrealDB 资源、工具、实用程序和应用程序列表

---

<div className="source-links">
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/vectorstores/surrealdb.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
