...
description: "在 LangChain JavaScript 中集成 CohereEmbeddings 嵌入模型。"
---

这将帮助您使用 LangChain 开始使用 CohereEmbeddings [嵌入模型](/oss/javascript/integrations/text_embedding)。有关 `CohereEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_cohere.CohereEmbeddings.html)。
...
我们可以实例化一个自定义 `CohereClient` 并将其传递给 ChatCohere 构造函数。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/text_embedding/cohere.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
