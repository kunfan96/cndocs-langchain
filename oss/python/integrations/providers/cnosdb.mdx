---
title: "Cnosdb 集成"
description: "使用 LangChain Python 与 Cnosdb 进行集成。"
---

> [CnosDB](https://github.com/cnosdb/cnosdb) 是一款高性能、高压缩率且易于使用的开源分布式时序数据库。
...
```
参数：
1. url (str)：CnosDB 服务的 HTTP 连接主机名和端口号，不包含 "http://" 或 "https://"，默认值为
                "127.0.0.1:8902"。
...
### SQL 数据库链
本示例演示了如何使用 SQL Chain 来回答关于 CnosDB 的问题。
```python
...
```
### SQL 数据库智能体
本示例演示了如何使用 SQL 数据库智能体来回答关于 CnosDB 的问题。
```python
