...
这份使用 LangGraph 的公司及其成功故事列表是根据公开来源汇编的。如果您所在的公司使用 LangGraph，我们很乐意您分享您的故事并将其添加到列表中。您也可以根据其他公司的公开信息（如博客文章或新闻稿）贡献更新。

| 公司 | 行业 | 用例 | 参考 |
| --- | --- | --- | --- |
| [AirTop](https://www.airtop.ai/) | 软件与技术（原生 GenAI） | AI 代理的浏览器自动化 | [案例研究, 2024](https://blog.langchain.dev/customers-airtop/) |
| [AppFolio](https://www.appfolio.com/) | 房地产 | 领域特定任务的 Copilot | [案例研究, 2024](https://blog.langchain.dev/customers-appfolio/) |
| [Athena Intelligence](https://www.athenaintel.com/) | 软件与技术（原生 GenAI） | 研究与总结 | [案例研究, 2024](https://blog.langchain.dev/customers-athena-intelligence/) |
...
| [Unify](https://www.unifygtm.com/) | 软件与技术（原生 GenAI） | 领域特定任务的 Copilot | [Interrupt 演讲, 2025](https://youtu.be/pKk-LfhujwI?feature=shared); [博客文章, 2024](https://blog.langchain.dev/unify-launches-agents-for-account-qualification-using-langgraph-and-langsmith/) |
...
| [11x](https://www.11x.ai/) | 软件与技术（原生 GenAI） | 研究与外联 | [Interrupt 演讲, 2025](https://youtu.be/fegwPmaAPQk?feature=shared) |
