---
title: 使用 SAP HANA Cloud 向量引擎的自查询
---
有关如何设置 SAP HANA 向量存储的更多信息，请查阅[文档](/oss/python/integrations/vectorstores/sap_hanavector)。
...
为了能够以良好的性能进行自查询，我们需要在 HANA 的向量存储表中创建额外的元数据字段：
...
以下是为 HANA 向量存储构建 SelfQueryRetriever 的主要步骤：
...
<Callout icon="edit">
    [在 GitHub 上编辑此页](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/self_query/hanavector_self_query.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
