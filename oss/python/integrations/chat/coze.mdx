---
title: "与Coze机器人聊天集成"
description: "使用LangChain Python集成与Coze机器人聊天模型。"
---

ChatCoze聊天模型API由coze.com提供。更多信息，请参阅 [https://www.coze.com/open/docs/chat](https://www.coze.com/open/docs/chat)
...
<Callout icon="edit">
    [在GitHub上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/chat/coze.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>