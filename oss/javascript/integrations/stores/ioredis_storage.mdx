---
title: "Ioredis 集成"
description: "使用 LangChain JavaScript 与 Ioredis 存储进行集成。"
---

此示例演示如何使用 `RedisByteStore` [`BaseStore`](https://reference.langchain.com/javascript/langchain-core/stores/BaseStore) 集成来设置聊天历史存储。
...
// 定义用于在字符串和 Uint8Array 之间转换的编码器/解码器
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/stores/ioredis_storage.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
