---
title: "Ionic 购物集成"
description: "使用 LangChain Python 集成 Ionic 购物工具。"
---

[Ionic](https://www.ioniccommerce.com/) 是一个面向 AI 助手的即插即用电商平台。通过在您的 Agent 中集成 [Ionic 工具](https://github.com/ioniccommerce/ionic_langchain)，您可以轻松地让用户直接在 Agent 中进行购物和交易，同时您也将获得交易分成。

这是一个基础的 Jupyter Notebook，演示了如何将 Ionic 工具集成到您的 Agent 中。有关使用 Ionic 设置 Agent 的更多信息，请参阅 Ionic [文档](https://docs.ioniccommerce.com/introduction)。

本 Jupyter Notebook 演示了如何在 Agent 中使用 Ionic 工具。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/tools/ionic_shopping.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
