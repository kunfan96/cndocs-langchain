...
使用该嵌入模型需要 API 密钥。您可以在 [platform.SparkLLM-ai.com/docs/text-Embedding](https://platform.SparkLLM-ai.com/docs/text-Embedding) 注册获取。

SparkLLMTextEmbeddings 支持 2K token 上下文窗口，生成 2560 维的向量。
