...
本指南提供了快速入门 PDFMiner [文档加载器](/oss/python/integrations/document_loaders) 的概览。有关所有 `PDFMinerLoader` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/PDFMinerLoader)。
...
如果您想获得模型调用的自动化一流跟踪，也可以通过取消注释以下内容来设置您的 [LangSmith](/langsmith/home) API 密钥：
...
有关所有 `PDFMinerLoader` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/PDFMinerLoader)
