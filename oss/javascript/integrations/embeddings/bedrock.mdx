...
sidebarTitle: "嵌入"
description: "使用 LangChain JavaScript 与 BedrockEmbeddings 嵌入模型集成。"
---
...
这将帮助您使用 LangChain 开始使用 Amazon Bedrock [嵌入模型](/oss/javascript/integrations/embeddings)。有关 `Bedrock` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-aws/BedrockEmbeddings)。
...
如果您想自定义选项（如 `credentials`、`region`、`retryPolicy` 等），可以传入您自己的 `BedrockRuntimeClient` 实例。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/embeddings/bedrock.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
