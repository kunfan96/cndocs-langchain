...
要启用使用`interrupt()`的[Human in the Loop](/oss/python/langgraph/interrupts)，我们需要使用[检查点](/oss/python/langgraph/persistence)编译以在运行之间保存状态：
...
<CardGroup cols={2}>
    <Card title="Human in the Loop模式" icon="user-check" href="/oss/python/langgraph/interrupts">
