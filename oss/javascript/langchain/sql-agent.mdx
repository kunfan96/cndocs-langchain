...
- [人在回路中](/oss/javascript/langchain/human-in-the-loop) 流程
...
<Note>
    你可以在 [LangSmith 跟踪](https://smith.langchain.com/public/653d218b-af67-4854-95ca-6abecb9b2520/r) 中检查上述运行的所有方面，包括采取的步骤、调用的工具、大语言模型看到的提示等。
</Note>
