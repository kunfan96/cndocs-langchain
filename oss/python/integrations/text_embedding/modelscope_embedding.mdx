---
title: "ModelScope 集成"
description: "使用 LangChain Python 集成 ModelScope 嵌入模型。"
---

ModelScope（[首页](https://www.modelscope.cn/) | [GitHub](https://github.com/modelscope/modelscope)）建立在"模型即服务"（MaaS）的理念之上，旨在汇聚 AI 社区中最先进的机器学习模型，并简化在实际应用中使用 AI 模型的流程。该仓库中开源的核心 ModelScope 库提供了接口和实现，使开发者能够进行模型推理、训练和评估。

本文将帮助您开始使用 LangChain 的 ModelScope 嵌入模型。
...
前往 [ModelScope](https://modelscope.cn/) 注册账户。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/text_embedding/modelscope_embedding.mdx) 或 [提交 Issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
