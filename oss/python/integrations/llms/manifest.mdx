---
title: "Manifest 集成"
description: "使用 LangChain Python 集成 Manifest LLM。"
---

本 notebook 介绍如何结合使用 Manifest 和 LangChain。

有关 `manifest` 的详细信息，以及如何与本示例中的本地 Hugging Face 模型配合使用，请参阅 [github.com/HazyResearch/manifest](https://github.com/HazyResearch/manifest)。

另一个[将 Manifest 与 LangChain 结合使用的示例](https://github.com/HazyResearch/manifest/blob/main/examples/langchain_chatgpt.html)。
