---
title: "PubMed 集成"
description: "使用 LangChain Python 与 PubMed 工具集成。"
---

>[PubMed®](https://pubmed.ncbi.nlm.nih.gov/) 包含来自 `MEDLINE`、生命科学期刊和在线书籍的超过 3500 万条生物医学文献引用。引用可能包含来自 PubMed Central 和出版商网站的全文内容链接。

本笔记本介绍如何使用 `PubMed` 作为工具。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/tools/pubmed.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
