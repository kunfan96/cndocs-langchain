...
为使用 `createAgent` 创建的代理构建丰富的交互式前端。这些模式涵盖了从基本消息渲染到高级工作流（如人工介入审批和时间旅行调试）的所有内容。
...
<CardGroup cols={3}>
  ...
  <Card title="人工介入" icon="user-check" href="/oss/python/langchain/frontend/human-in-the-loop">
...
<CardGroup cols={3}>
  <Card title="连接与重新连接流" icon="plug-connected" href="/oss/python/langchain/frontend/join-rejoin">
