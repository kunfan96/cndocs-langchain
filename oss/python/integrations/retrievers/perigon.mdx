---
title: "Perigon 集成"
description: "使用 LangChain Python 集成 Perigon 检索器。"
---

Perigon API 套件提供对全球新闻和事件的快速、结构化访问，帮助您构建实时、数据驱动的产品。无论是追踪新兴风险、筛选相关文章，还是挖掘关键洞察，Perigon 都能为您提供编程实现所需的工具。

与传统基于关键词的搜索不同，Perigon 的语义搜索能力可以在上下文层面理解查询，并返回相关文档。

本 notebook 演示如何在 LangChain 中使用 Perigon 的检索器，涵盖新闻文章和 Wikipedia 内容。
...
使用此集成需要 Perigon API 密钥。请在 [Perigon.io](https://perigon.io/) 注册以获取 API 密钥。
...
ArticlesRetriever 允许您使用语义搜索功能检索新闻文章：
...
WikipediaRetriever 提供对 Wikipedia 内容的语义搜索功能，并附带丰富的元数据：
...
您可以按热度、分类和其他元数据过滤 Wikipedia 结果：
...
<Callout icon="edit">
    [在 GitHub 上编辑此页](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/perigon.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
