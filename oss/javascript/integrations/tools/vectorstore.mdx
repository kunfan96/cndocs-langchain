...
description: "使用 LangChain JavaScript 与 VectorStoreToolkit 工具集成。"
---
...
`VectorStoreToolkit` 是一个工具包，它接收一个向量存储，并将其转换为一个可以调用、传递给 LLM、代理等的工具。

## 设置

如果您想从单个工具的运行中获得自动跟踪，也可以通过取消注释下方内容来设置您的 [LangSmith](/langsmith/home) API 密钥：
