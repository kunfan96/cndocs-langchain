...
[RecursiveCharacterTextSplitter](https://reference.langchain.com/python/langchain-text-splitters/character/RecursiveCharacterTextSplitter) 包含预置的分隔符列表，可用于[分割文本](/oss/python/integrations/splitters/)以支持特定编程语言。
