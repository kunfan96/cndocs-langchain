...
title: "沙箱集成"
sidebarTitle: 沙箱
description: "使用 LangChain JavaScript 与沙箱提供商集成。"
---

沙箱为安全运行代理生成的代码提供隔离的执行环境。了解更多关于[沙箱](/oss/javascript/deepagents/sandboxes)的信息。
...
如果您想贡献一个沙箱，请参阅[实现沙箱集成](/oss/javascript/contributing/implement-langchain#sandboxes)。
