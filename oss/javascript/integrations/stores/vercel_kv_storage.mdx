---
title: "Vercel KV 集成"
description: "使用 LangChain JavaScript 与 Vercel KV 存储集成。"
---

本示例演示如何使用 `VercelKVStore` [`BaseStore`](https://reference.langchain.com/javascript/langchain-core/stores/BaseStore) 集成设置聊天历史记录存储。
