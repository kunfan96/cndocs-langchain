---
title: "火山引擎重排序集成"
description: "使用 LangChain Python 集成火山引擎重排序文档转换器。"
---

本 notebook 演示如何使用火山引擎重排序进行文档压缩和检索。[火山引擎](https://www.volcengine.com/)是由 TikTok 母公司字节跳动开发的云服务平台。

火山引擎的重排序服务支持对最多 50 篇文档进行重排序，最大支持 4000 个 token。更多信息请访问[此处](https://www.volcengine.com/docs/84313/1254474)和[此处](https://www.volcengine.com/docs/84313/1254605)。
...
现在让我们使用 `ContextualCompressionRetriever` 封装基础检索器，并使用 `VolcengineRerank` 对返回结果进行重排序。
