...
如果您还想以结构化方式获取包含元数据的结果。为此，我们将使用包装器的 `results` 方法。
...
有关所有支持的过滤器，请访问 [Google Search](https://google.com)，搜索某些内容，点击“工具”，添加您的日期过滤器，然后检查 URL 中的“tbs=”。

## 搜索 Google 地点

我们也可以使用此包装器查询 Google 地点。例如：
