...
>[Golden](https://golden.com) 提供了一套自然语言 API，用于使用 Golden 知识图谱进行查询和丰富信息，例如查询如：`Products from OpenAI`、`Generative ai companies with series a funding` 和 `rappers who invest` 可用于检索相关实体的结构化数据。
>
...
- 前往 [Golden API 文档](https://docs.golden.com/) 获取 Golden API 的概述。
