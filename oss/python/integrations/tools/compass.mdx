---
title: "Compass 去中心化金融工具包集成"
description: "使用 LangChain Python 集成 Compass 去中心化金融工具包。"
---

与各种去中心化金融协议交互。非托管。工具返回*未签名交易*。该工具包构建于通用去中心化金融 API（[Compass API](https://api.compasslabs.ai/)）之上，允许代理执行以下金融操作：
