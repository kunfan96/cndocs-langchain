...
这将帮助你开始使用 `AzionRetriever` [检索](/oss/javascript/langchain/retrieval)。有关所有 `AzionRetriever` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-community/retrievers/azion_edgesql/AzionRetriever)。
...
如果你想从单个查询中获得自动跟踪，你也可以通过取消注释以下内容来设置你的 [LangSmith](/langsmith/home) API 密钥：
...
有关所有 `AzionRetriever` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-community/retrievers/azion_edgesql/AzionRetriever)。
