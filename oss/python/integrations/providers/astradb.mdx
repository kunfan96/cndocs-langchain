---
title: "Astra DB 集成"
description: "使用 LangChain Python 与 Astra DB 集成。"
---

> [DataStax Astra DB](https://docs.datastax.com/en/astra-db-serverless/index.html) 是一个基于 `Apache Cassandra®` 构建的无服务器、AI 就绪数据库，并通过易于使用的 JSON API 便捷地提供服务。

参阅 [DataStax 提供的教程](https://docs.datastax.com/en/astra/astra-db-vector/tutorials/chatbot.html)。
...
- 从现有的、已填充数据的 Astra DB 集合中自动检测其设置；
...
参阅 [DataStax 提供的示例](https://docs.datastax.com/en/astra/astra-db-vector/integrations/langchain.html)。
...
参阅 [AstraDBStore](https://reference.langchain.com/python/langchain-astradb/storage/AstraDBStore) 的 API 参考。
...
参阅 [AstraDBByteStore](https://reference.langchain.com/python/langchain-astradb/storage/AstraDBByteStore) 的 API 参考。
