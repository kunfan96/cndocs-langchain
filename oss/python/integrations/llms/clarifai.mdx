---
title: "Clarifai 集成"
description: "使用 LangChain Python 与 Clarifai LLM 进行集成。"
---
...
在此我们将设置个人访问令牌。您可以在 Clarifai 账户的 [settings/security](https://clarifai.com/settings/security) 下找到您的 PAT。
...
配置模型所在的用户 ID 和应用 ID。您可以在 [clarifai.com/explore/models](https://clarifai.com/explore/models) 上找到公共模型列表。

您还需要初始化模型 ID，如果需要的话，还包括模型版本 ID。某些模型有多个版本，您可以选择适合您任务的版本。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/llms/clarifai.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
