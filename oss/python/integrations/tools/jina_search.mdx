...
本指南提供了快速入门 `JinaSearch` [工具](/oss/python/integrations/tools/)的概览。有关所有 `JinaSearch` 功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-community/tools/jina_search/tool/JinaSearch)。
...
| 类 | 包 | 可序列化 | JS 支持 | 版本 |
| :--- | :--- | :---: | :---: | :---: |
| [`JinaSearch`](https://reference.langchain.com/python/langchain-community/tools/jina_search/tool/JinaSearch) | [`langchain-community`](https://reference.langchain.com/python/langchain-community) | ❌ | ❌ | ![PyPI - Version](https://img.shields.io/pypi/v/langchain-community?style=flat-square&label=%20) |

### 工具特性

| [返回制品](/oss/python/langchain/tools) | 原生异步 | 返回数据 | 定价 |
| :---: | :---: | :---: | :---: |
| ❌ | ❌ | URL、摘要、标题、页面内容 | 1M 响应令牌免费 |
...
我们也可以使用模型生成的 ToolCall 来调用工具，这种情况下会返回一个 ToolMessage：
...
我们可以在链中使用我们的工具，首先将其绑定到一个[工具调用模型](/oss/python/langchain/tools/)，然后调用它：
...
有关所有 Jina 功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-community/tools/jina_search/tool/JinaSearch)
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/tools/jina_search.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>