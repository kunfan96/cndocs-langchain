...
export const run = async () => {
  ...
  const chatMessages = [
    {
      role: "AI",
      message: "Bonjour! 今天我能如何协助您制定旅行计划？",
    },
    { role: "User", message: "我正在计划一次法国之旅。" },
    {
      role: "AI",
      message: "听起来很令人兴奋！您计划访问哪些城市？",
    },
    { role: "User", message: "我在考虑去巴黎和尼斯。" },
    {
      role: "AI",
    ...
    { role: "User", message: "我很想去参观一些葡萄园。" },
    {
      role: "AI",
      message:
        "法国拥有一些世界上最好的葡萄园。我可以帮您找一些。",
    },
    { role: "User", message: "那太好了！" },
    { role: "AI", message: "您喜欢红葡萄酒还是白葡萄酒？" },
    ...
    {
      role: "User",
      message: "听起来很棒。我等不及要开始我的旅行了！",
    },
    {
      role: "AI",
      message:
        "我相信您会度过一段美好的时光。关于您的旅行，您还有其他问题吗？",
    },
    { role: "User", message: "暂时没有了，谢谢您的帮助！" },
  ];
