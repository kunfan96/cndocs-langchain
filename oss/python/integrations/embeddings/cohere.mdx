...
本指南将帮助您开始使用 LangChain 集成 Cohere 嵌入模型。有关 `CohereEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-cohere/embeddings/CohereEmbeddings)。
...
LangChain Cohere 集成包含在 `langchain-cohere` 包中：
