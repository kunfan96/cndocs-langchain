---
title: "Bageldb 集成"
description: "使用 LangChain Python 与 Bageldb 向量存储集成。"
---

> [BagelDB](https://www.bageldb.ai/) (`Open Vector Database for AI`)，类似于 AI 数据的 GitHub。
它是一个协作平台，用户可以在其中创建、
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/vectorstores/bageldb.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>