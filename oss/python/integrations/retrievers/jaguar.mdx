---
title: "JaguarDB 向量数据库集成"
description: "使用 LangChain Python 与 JaguarDB 向量数据库检索器集成。"
---

>[JaguarDB 向量数据库]([www.jaguardb.com/windex.html](http://www.jaguardb.com/windex.html)
>
>1. 它是一个分布式向量数据库
>2. JaguarDB 的“ZeroMove”功能实现了即时的水平扩展
...
本节演示在 langchain 软件栈中与 Jaguar 一起与 LLM 进行聊天。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/jaguar.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>