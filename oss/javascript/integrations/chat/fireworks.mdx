...
本指南将帮助您开始使用 `ChatFireworks` [聊天模型](/oss/javascript/langchain/models)。有关所有 `ChatFireworks` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-community/chat_models/fireworks/ChatFireworks)。
...
有关所有 `ChatFireworks` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-community/chat_models/fireworks/ChatFireworks)。
