---
title: "Comet 集成"
description: "使用 LangChain Python 与 Comet 集成。"
---

>[Comet](https://www.comet.com/) 机器学习平台可与您现有的基础设施和工具集成，使您能够管理、可视化和优化模型——从训练运行到生产监控。
...
您可以在此处获取您的 [Comet API 密钥](https://www.comet.com/signup?utm_source=langchain&utm_medium=referral&utm_campaign=comet_notebook)，或在初始化 Comet 后点击链接。
...
查看一个[示例](/oss/python/integrations/callbacks/comet_tracing)。
