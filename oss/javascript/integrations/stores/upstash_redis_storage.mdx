...
description: "使用 LangChain JavaScript 与 Upstash Redis 存储集成。"
---

本示例演示如何使用 `UpstashRedisStore` [`BaseStore`](https://reference.langchain.com/javascript/langchain-core/stores/BaseStore) 集成来设置聊天历史存储。
...
// 定义编码器/解码器，用于在字符串和 Uint8Arrays 之间转换
