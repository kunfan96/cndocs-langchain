---
title: "Zep 开源集成"
description: "使用 LangChain Python 集成 Zep 开源检索器。"
---
...
> 有兴趣使用 Zep Cloud？请参阅 [Zep Cloud 安装指南](https://help.getzep.com/sdks) 和 [Zep Cloud 检索器示例](https://help.getzep.com/langchain/examples/rag-message-history-example)
...
本 notebook 演示如何使用 [Zep 长期记忆存储](https://getzep.github.io/)搜索历史聊天消息记录。
