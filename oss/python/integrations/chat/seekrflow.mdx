...
description: "使用 LangChain Python 与 ChatSeekrFlow 聊天模型集成。"
---

> [Seekr](https://www.seekr.com/) 提供 AI 驱动的解决方案，用于结构化、可解释和透明的 AI 交互。

本指南提供了快速入门 `ChatSeekrFlow` [聊天模型](/oss/python/langchain/models)的概览。

## 概述

`ChatSeekrFlow` 类封装了托管在 SeekrFlow 上的聊天模型端点，可与 LangChain 应用程序无缝集成。
