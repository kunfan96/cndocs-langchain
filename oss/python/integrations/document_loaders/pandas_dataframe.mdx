...
description: "使用 LangChain Python 集成 Pandas DataFrame 文档加载器。"
---

本 notebook 介绍如何从 [pandas](https://pandas.pydata.org/pandas-docs/stable/user_guide/index) DataFrame 加载数据。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/pandas_dataframe.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
