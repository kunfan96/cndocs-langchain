---
title: "Doctran 审讯文档集成"
description: "使用 LangChain Python 与 Doctran 审讯文档文档转换器集成。"
---

向量存储知识库中使用的文档通常以叙述或对话格式存储。然而，大多数用户查询都是问题格式。如果我们在向量化之前将文档**转换为问答格式**，就可以增加检索相关文档的可能性，并减少检索不相关文档的可能性。

我们可以使用 [Doctran](https://github.com/psychic-api/doctran) 库来实现这一点，该库使用 OpenAI 的函数调用功能来“审讯”文档。

有关基于原始文档与审讯文档的各种查询的向量相似度分数的基准测试，请参见[此笔记本](https://github.com/psychic-api/doctran/blob/main/benchmark.ipynb)。
...
审讯文档后，结果将作为新文档返回，其中问题和答案在元数据中提供。
