...
本文档将帮助您快速上手 Netmind [聊天模型](https://www.netmind.ai/)。有关 ChatNetmind 所有功能和配置的详细文档，请参阅 [API 参考](https://github.com/protagolabs/langchain-netmind)。

- 相关示例请参阅 [www.netmind.ai/](https://www.netmind.ai/)。
...
前往 [www.netmind.ai/](https://www.netmind.ai/) 注册 Netmind 账户并生成 API 密钥。完成后，设置 NETMIND_API_KEY 环境变量：
...
如果您希望启用模型调用的自动追踪，也可以取消注释以下内容设置您的 [LangSmith](/langsmith/home) API 密钥：
