...
description: "使用 LangChain Python 集成 Nebula (Symbl.ai) LLM。"
---

[Nebula](https://symbl.ai/nebula/) 是由 [Symbl.ai](https://symbl.ai) 构建的大型语言模型（LLM）。它经过训练，可以在人类对话中执行生成任务。Nebula 擅长建模对话中的细微细节，并对对话执行任务。

Nebula 文档：[docs.symbl.ai/docs/nebula-llm](https://docs.symbl.ai/docs/nebula-llm)

本示例介绍了如何使用 LangChain 与 [Nebula 平台](https://docs.symbl.ai/docs/nebula-llm)进行交互。

请确保您有 API 密钥。如果没有，请[申请一个](https://info.symbl.ai/Nebula_Private_Beta.html)。
