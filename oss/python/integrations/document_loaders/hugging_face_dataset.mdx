...
>[Hugging Face Hub](https://huggingface.co/docs/hub/index) 拥有超过 5,000 个[数据集](https://huggingface.co/docs/hub/index#datasets)，涵盖 100 多种语言，可用于自然语言处理、计算机视觉和音频等广泛领域的任务。这些数据集用于各种任务，例如翻译、自动语音识别和图像分类。
