...
**反馈**是 LangSmith 在特定追踪或中间运行（区间）上存储评估标准和分数的方式。反馈可以通过多种方式产生，例如：

1. [随追踪一起从 LLM 应用发送](/langsmith/attach-user-feedback)
2. 由用户在应用中[内联](/langsmith/annotate-traces-inline)或在[标注队列](/langsmith/annotation-queues)中生成
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/langsmith/feedback-data-format.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>