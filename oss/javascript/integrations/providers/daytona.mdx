...
description: "使用 Daytona 沙盒后端和 deepagents 进行隔离的代码执行，具有快速冷启动特性"
---

[Daytona](https://daytona.io) 提供支持多语言的快速启动沙盒环境。最适合 TypeScript 和 Python 开发。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/providers/daytona.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
