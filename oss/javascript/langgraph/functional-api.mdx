...
<Tip>
有关如何使用功能性 API 的信息，请参见 [Use Functional API](/oss/javascript/langgraph/use-functional-api)。
</Tip>
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/langgraph/functional-api.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
