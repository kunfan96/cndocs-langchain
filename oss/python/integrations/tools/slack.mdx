...
要使用此工具包，您需要按照 [Slack API 文档](https://api.slack.com/tutorials/tracks/getting-a-token) 中的说明获取一个令牌。一旦您获得了 SLACK_USER_TOKEN，就可以在下方将其作为环境变量输入。
...
可选地，我们可以安装 beautifulsoup4 来辅助解析 HTML 消息：
...
让我们为一个代理配备 Slack 工具包，并查询有关某个频道的信息。
