...
本指南将帮助您开始在 DigitalOcean Gradient [聊天模型](/oss/python/langchain/models) 上使用 `ChatGradient`。
...
2. 转到 Gradient 平台并导航至 Serverless Inference。
...
DigitalOcean Gradient 集成包含在 `langchain-gradient` 包中：
...
有关所有 `ChatGradient` 功能和配置的详细文档，请前往 API 参考。
