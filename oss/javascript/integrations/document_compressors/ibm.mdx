...
description: "使用 LangChain JavaScript 与 IBM watsonx.ai 文档压缩器集成。"
---

## 概述

这将帮助您开始使用 Watsonx [文档压缩器](/oss/javascript/concepts/#document_compressors)。有关所有 Watsonx 文档压缩器功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-community/document_compressors/ibm/WatsonxRerank)。

### 集成详情

| 类 | 包 | [PY 支持](https://python.langchain.com/docs/integrations/retrievers/ibm_watsonx_ranker/) | 下载量 | 版本 |
| :--- | :--- | :---: | :---: | :---: |
...
前往 [IBM Cloud](https://cloud.ibm.com/login) 注册 IBM watsonx.ai 并生成 API 密钥，或提供如下所示的任何其他身份验证形式。
...
首先，设置一个基本的 RAG 摄取管道，包含嵌入、文本分割器和向量存储。我们将使用它来重排序一些与所选查询相关的文档：
...
或者，您也可以让文档随结果一起返回，为此请使用下面的 `.compressDocuments()` 方法。
...
有关所有 Watsonx 文档压缩器功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-community/document_compressors/ibm/WatsonxRerank)。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/document_compressors/ibm.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>