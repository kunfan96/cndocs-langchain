...
百度AI云千帆平台是面向企业开发者的一站式大模型开发和服务运营平台。千帆不仅提供包括文心一言（ERNIE-Bot）模型及第三方开源模型在内的多种模型，还提供各种AI开发工具和全套开发环境，方便客户轻松使用和开发大模型应用。
...
在本笔记本中，我们将介绍如何主要使用 langchain 中的 `Embedding`（对应 `langchain/embeddings` 包）与 [千帆](https://cloud.baidu.com/doc/WENXINWORKSHOP/index.html) 进行集成。
...
如果您想部署基于文心一言或第三方开源模型的自定义模型，可以按照以下步骤操作：
