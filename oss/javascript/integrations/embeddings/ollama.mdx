...
description: "使用 LangChain JavaScript 集成 OllamaEmbeddings 嵌入模型。"
---

本指南将帮助您开始使用 LangChain 的 Ollama [嵌入模型](/oss/javascript/integrations/embeddings)。有关 `OllamaEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-ollama/OllamaEmbeddings)。
...
有关所有 `OllamaEmbeddings` 功能和配置的详细文档，请访问 [API 参考](https://reference.langchain.com/javascript/langchain-ollama/OllamaEmbeddings)
