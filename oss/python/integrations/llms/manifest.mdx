---
title: "Manifest 集成"
description: "使用 LangChain Python 与 Manifest LLM 集成。"
---

本笔记本介绍如何使用 Manifest 和 LangChain。

有关 `manifest` 的更多详细信息，以及如何在本示例中使用本地 Huggingface 模型，请参阅 [github.com/HazyResearch/manifest](https://github.com/HazyResearch/manifest)。

另一个 [使用 Manifest 与 LangChain](https://github.com/HazyResearch/manifest/blob/main/examples/langchain_chatgpt.html) 的示例。
