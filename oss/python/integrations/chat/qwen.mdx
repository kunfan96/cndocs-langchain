---
title: "ChatQwen 集成"
description: "使用 LangChain Python 与 ChatQwen 聊天模型集成。"
---

这将帮助您开始使用 Qwen [聊天模型](/oss/python/langchain/models)。有关所有 `ChatQwen` 功能和配置的详细文档，请前往 [API 参考](https://pypi.org/project/langchain-qwq/)。
...
ChatQwen 支持工具调用 API，允许您描述工具及其参数，并让模型返回一个包含要调用的工具和该工具输入的 JSON 对象。
...
有关所有 `ChatQwen` 功能和配置的详细文档，请前往 [API 参考](https://pypi.org/project/langchain-qwq/)

---

<div className="source-links">
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/chat/qwen.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
