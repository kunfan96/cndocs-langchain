---
title: "LanceDB 集成"
description: "使用 LangChain Python 与 LanceDB 向量存储进行集成。"
---

>[LanceDB](https://lancedb.com/) 是一个基于持久化存储构建的开源向量搜索数据库，它极大地简化了嵌入的检索、过滤和管理。完全开源。

此笔记本展示了如何使用基于 Lance 数据格式的 `LanceDB` 向量数据库的相关功能。
...
此外，要探索表，您可以将其加载到 df 中或保存到 csv 文件中：
