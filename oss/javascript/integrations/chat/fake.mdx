---
title: "假集成"
description: "使用 LangChain JavaScript 与假聊天模型集成。"
---

LangChain 提供了一个用于测试目的的假 LLM 聊天模型。这允许你模拟对 LLM 的调用，并模拟如果 LLM 以某种方式响应会发生什么。
