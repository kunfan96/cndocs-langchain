...
description: "使用 LangChain Python 与 Pandas DataFrame 文档加载器集成。"
---

本笔记本介绍如何从 [pandas](https://pandas.pydata.org/pandas-docs/stable/user_guide/index) DataFrame 加载数据。
