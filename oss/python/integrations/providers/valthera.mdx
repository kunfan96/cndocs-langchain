...
> [Valthera](https://github.com/valthera/valthera) 是一个开源框架，赋能 LLM 智能体驱动有意义、上下文感知的用户互动。它实时评估用户动机和能力，确保仅在用户最易接受时触发通知和操作。
>
> **langchain-valthera** 将 Valthera 与 LangChain 集成，使开发者能够构建更智能、行为驱动的互动系统，提供个性化交互。
...
此示例展示如何使用 `DataAggregator` 和动机与能力评分配置初始化 ValtheraTool。

```python
import os
from langchain_openai import ChatOpenAI
from valthera.aggregator import DataAggregator
from mocks import hubspot, posthog, snowflake  # 替换为您的实际连接器实现
from langchain_valthera.tools import ValtheraTool
...
print("✅ ValtheraTool 已成功初始化，用于 LangChain 集成！")
```


langchain-valthera 集成允许您评估用户行为并决定最佳互动策略，确保在您的 LangChain 应用中交互既及时又相关。

---

<div className="source-links">
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/valthera.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
