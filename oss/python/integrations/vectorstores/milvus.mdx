---
title: "Milvus 集成"
description: "使用 LangChain Python 与 Milvus 向量存储集成。"
---
...
Milvus 建议使用 [partition_key](https://milvus.io/docs/multi_tenancy.md#Partition-key-based-multi-tenancy) 来实现多租户。以下是示例：
