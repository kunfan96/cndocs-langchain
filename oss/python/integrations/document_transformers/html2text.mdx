---
title: "HTML转文本集成"
description: "使用LangChain Python集成HTML转文本文档转换器。"
---

>[html2text](https://github.com/Alir3z4/html2text/) 是一个Python包，可以将一页 `HTML` 转换为干净、易于阅读的纯 `ASCII文本`。
...
<Callout icon="edit">
    [在GitHub上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_transformers/html2text.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
