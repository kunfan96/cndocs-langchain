...
description: "使用 LangChain Python 集成 ChatEverlyAI 聊天模型。"
---

>[EverlyAI](https://everlyai.xyz) 允许您在云端大规模运行 ML 模型，并提供对[多种 LLM 模型](https://everlyai.xyz)的 API 访问。

本 notebook 演示了如何使用 `langchain.chat_models.ChatEverlyAI` 调用 [EverlyAI 托管端点](https://everlyai.xyz/)。
