---
title: "火山引擎集成"
description: "使用 LangChain Python 集成 VolcEngine 嵌入模型。"
---

本指南为您提供如何加载 Volcano Embedding 类的详细步骤。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/embeddings/volcengine.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
<Callout icon="terminal-2">
    [将这些文档](/use-these-docs) 通过 MCP 与 Claude、VSCode 等工具连接，以获取实时答案。
</Callout>
</div>