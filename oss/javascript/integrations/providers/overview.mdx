...
sidebarTitle: 概览
mode: wide
description: "使用 LangChain JavaScript/TypeScript 与提供商集成。"
---

LangChain 集成了各种各样的聊天和嵌入模型、工具和工具包、文档加载器、向量存储等。

**提供商**是 LangChain与之集成以访问 AI 功能（如聊天模型、嵌入和向量存储）的第三方服务或平台。这些提供商拥有独立的 `langchain-provider` 包，以改进版本控制、依赖管理和测试。
...
[查看所有提供商](/oss/javascript/integrations/providers/all_providers) 或使用搜索字段搜索提供商。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/providers/overview.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
