...
您还可以通过 ChatPerplexity 类使用 Perplexity 特定的参数。例如，使用 extra_body 参数传递 search_domain_filter、return_images、return_related_questions 或 search_recency_filter 等参数，如下所示：
