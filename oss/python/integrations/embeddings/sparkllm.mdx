---
title: "SparkLLM 文本集成"
description: "使用 LangChain Python 与 SparkLLM 文本嵌入模型进行集成。"
---

官方网站：[www.xfyun.cn/doc/spark/Embedding_new_api.html](https://www.xfyun.cn/doc/spark/Embedding_new_api.html)

使用此嵌入模型需要 API 密钥。您可以通过在 [platform.SparkLLM-ai.com/docs/text-Embedding](https://platform.SparkLLM-ai.com/docs/text-Embedding) 注册来获取。

SparkLLMTextEmbeddings 支持 2K Token 窗口，并生成具有 2560 维的向量。
