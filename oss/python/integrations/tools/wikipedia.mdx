---
title: "Wikipedia 集成"
description: "使用 LangChain Python 集成 Wikipedia 工具。"
---

>[Wikipedia](https://wikipedia.org/) 是一个多语言免费在线百科全书，由称为维基人的志愿者社区通过开放协作并使用名为 MediaWiki 的 wiki 编辑系统共同撰写和维护。`Wikipedia` 是历史上规模最大、阅读量最多的参考资料。
