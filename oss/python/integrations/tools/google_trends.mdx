---
title: "Google 趋势集成"
description: "使用 LangChain Python 集成 Google 趋势工具。"
---

本文档介绍如何使用 Google 趋势工具获取趋势信息。
...
接着需要将环境变量 `SERPAPI_API_KEY` 设置为您的 `SerpApi key`。

[您也可以通过参数传入密钥：`serp_api_key="your secret key"`]
