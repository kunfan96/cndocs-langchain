...
这将帮助您开始使用 `langchain_huggingface` [聊天模型](/oss/python/langchain/models)。有关所有 `ChatHuggingFace` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/python/langchain-huggingface/chat_models/huggingface/ChatHuggingFace)。有关 Hugging Face 支持的模型列表，请查看 [此页面](https://huggingface.co/models)。
...
生成一个 [Hugging Face Access Token](https://huggingface.co/docs/hub/security-tokens) 并将其存储为环境变量：`HUGGINGFACEHUB_API_TOKEN`。
...
有关所有 `ChatHuggingFace` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/python/langchain-huggingface/chat_models/huggingface/ChatHuggingFace)

---

<div className="source-links">
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/chat/huggingface.mdx) 或 [提交问题](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
